...
double ComputeChiSquare(struct Dataset * Data, int NumberOfSpectra, struct Parameter * Parameters, int NumberOfParameters, int NumberOfSmearingFolds, double * VolumesOfMolecules, struct Protein ProteinStructure, struct UserDefined * UserDefinedStructure, int TotalNumberOfDatapoints, int NumberOfFreeParameters)
{
    // Declarations
...
void ComputeGradient(struct Dataset * Data, int NumberOfSpectra, struct Parameter * Parameters, int NumberOfParameters, int NumberOfSmearingFolds, double * VolumesOfMolecules, struct Protein ProteinStructure, struct UserDefined * UserDefinedStructure, double * Gradient, double DeltaForDifferentiations, int TotalNumberOfDatapoints, int NumberOfFreeParameters)
{
    // Declarations
    int i;
    double dParameter;
...
double PerformLinesearch(struct Dataset * Data, int NumberOfSpectra, struct Parameter * Parameters, int NumberOfParameters, int NumberOfSmearingFolds, double * VolumesOfMolecules, struct Protein ProteinStructure, struct UserDefined * UserDefinedStructure, double OriginalValue, double * Gradient, double * Direction, struct Parameter * NewParameters, double MaxStepSize, int TotalNumberOfDatapoints, int NumberOfFreeParameters)
{
