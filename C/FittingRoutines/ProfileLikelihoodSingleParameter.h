//
// NOTES:	NumberOfCycles (filled with FittingRoutineArgument3 in WillItFit.c) is not used, supposedly it was intented earlier for NumberOfSteps
//		NumberOfSteps is set with global constant EstimatedNumberOfStepsInLikelihoodProfile ( = 10), defined in WillItFit.c
//
// int ProfileLikelihoodSingleParameter(struct Dataset * Data, int NumberOfSpectra, struct Parameter * Parameters, int NumberOfParameters, int MaxIterations, double *ChiXX, int NumberOfSmearingFolds, double * VolumesOfMolecules, struct Protein ProteinStructure, struct UserDefined * UserDefinedStructure, double DeltaForDifferentiations, double ChiSquareFractile, int NumberOfCycles, char CardFileLocation[256], int ParameterID, int NumberOfSampleInformations, int TotalNumberOfDatapoints, int NumberOfFreeParameters, int HighestNumberOfDatapoints)
int ProfileLikelihoodSingleParameter(char CardFileLocation[256], struct Dataset * Data, int NumberOfSpectra, int TotalNumberOfDatapoints, int HighestNumberOfDatapoints, struct Parameter * Parameters, int NumberOfParameters, int NumberOfFreeParameters, double * VolumesOfMolecules, int NumberOfSampleInformations, struct Protein ProteinStructure, struct UserDefined * UserDefinedStructure, int MaxIterations, int NumberOfSmearingFolds, double DeltaForDifferentiations, double *ChiXX, double ChiSquareFractile, int NumberOfCycles, int ParameterID, char *ResultsDirectory, int WriteLog, FILE* logfile)
{
