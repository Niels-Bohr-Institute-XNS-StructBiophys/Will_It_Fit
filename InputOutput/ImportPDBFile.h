...
<<<<<<< HEAD
    ...
    // The above is not comepletely correct. It is possible to have the same functionality with nested switches:
    // One switch for the first character and nested switches for the second.
