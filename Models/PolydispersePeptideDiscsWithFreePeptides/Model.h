double Model(double q, double * Parameters, double * Constraints, double Contrast, struct Protein ProteinStructure, struct UserDefined * UserDefinedStructure)
{
    ...
    // Variables describing the peptide trimers
    double ConcentrationOfTrimers;
    double RadiusOfPeptideInTrimer;
    double HeightOfPeptideInTrimer;
    ...
    /// Add peptide trimers
    ConcentrationOfTrimers = Constraints[22];
    RadiusOfPeptideInTrimer = Parameters[22];
    HeightOfPeptideInTrimer = Constraints[23];

    Intensity += PeptideTrimer(q, RadiusOfPeptideInTrimer, HeightOfPeptideInTrimer, ScatteringLengthOfBelt, ConcentrationOfTrimers);
