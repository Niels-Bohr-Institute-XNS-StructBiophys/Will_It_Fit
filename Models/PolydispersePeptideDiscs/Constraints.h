                        ...
                        double Concentration, double * Constraints, struct Protein ProteinStructure, struct UserDefined * UserDefinedStructure)
{
    ...
    Area   = AreaPerHeadgroupOfLipids * NLipidsMean / 2.0;
    Radius = sqrt(Area / pi);
    TotalVolumeOfBeltMean = pi * HeightOfBelt * pow(Radius + Parameters[0], 2) - pi * HeightOfBelt * pow(Radius, 2);
    NumberOfPeptidesMean  = TotalVolumeOfBeltMean / VolumeOfBelt;
    ...
    Constraints[21] = Concentration / NumberOfPeptidesMean / CorrectionDueToUnusedDiscs;
    Constraints[22] = NumberOfPeptidesMean;
    Constraints[23] = LipidsPerPeptideInDiscs;
    Constraints[24] = 0.0;
