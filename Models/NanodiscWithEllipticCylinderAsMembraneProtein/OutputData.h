                ...
                struct UserDefined UserDefinedStructure, char SampleFilename[256])
{
    ...
    for (i = 0; i < NumberOfSpectra; ++i) {
        ...
        fprintf(fp, "Excess scattering length density of MP         = %g \n", Data[i].Constraints[5]);
        fprintf(fp, "\n");
    }
    ...
    fprintf(fp, "Height of MP                  = %g \n", Data[0].Constraints[9]);
    fprintf(fp, "Minor semiaxis of MP          = %g \n", Data[0].Constraints[10]);
    fprintf(fp, "Major semiaxis of MP          = %g \n", Data[0].Constraints[11]);
